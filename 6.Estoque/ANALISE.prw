...
User Function AjEst()
    ...
    Private cPict        := '@E 9,999,999.9999'//PesqPict('SB8','B8_SALDO')
    Private cPict2UM     := '@E 9,999,999.9999'//PesqPict('SB8','B8_SALDO')
    Private cPictD5      := '@E 9,999,999.9999'//PesqPict('SD5','D5_QUANT')
    Private cPictDB      := '@E 9,999,999.9999'//PesqPict('SD5','D5_QUANT')
...
*/
    ...
    @ 005,445 BUTTON "&Parâmetros"  SIZE 30,10 PIXEL OF oFolder:aDialogs[1] ACTION fPermiteAjsute(cPerg)
...
// Detalhe do SB8            
    ...
    oDetSB8:bLine:={ ||{aDetSB8[oDetSB8:nAT,1],aDetSB8[oDetSB8:nAT,2],aDetSB8[oDetSB8:nAT,3],aDetSB8[oDetSB8:nAT,4],TransForm(aDetSB8[oDetSB8:nAT,5],cPict),TransForm(aDetSB8[oDetSB8:nAT,6],cPict),aDetSB8[oDetSB8:nAT,7],aDetSB8[oDetSB8:nAT,8],aDetSB8[oDetSB8:nAT,9],aDetSB8[oDetSB8:nAT,10]}}
    oDetSB8:Refresh()
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Detalhe do SD5
...
aadd(aHeader, {"Qtde."            , "QTDE"    , cPictD5           , 18       , 4         ,"U_ValidACols()"       , ""      , "N"    , ""        ,,})
aadd(aHeader, {"Qtde.UM2"         , "QTDE2UM" , cPict2UM          , 18       , 4         ,"U_ValidACols()"       , ""      , "N"    , ""        ,,})
