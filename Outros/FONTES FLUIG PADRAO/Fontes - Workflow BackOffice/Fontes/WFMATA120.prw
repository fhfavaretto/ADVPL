...
oBrowse:SetDescription(STR0001) // "Aprovação Pedido de Compras"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
oBrowse:Activate()
...
// -----------------------------------------------------------------------
oModel:GetModel( 'WF1MASTER' ):SetDescription( STR0052 ) // 'Decisão'
oModel:GetModel( 'WF2DETAIL' ):SetDescription( STR0053 ) // 'Informações do Documento'
oModel:GetModel( 'WF3DETAIL' ):SetDescription( STR0054 ) // 'Itens'
oModel:GetModel( 'WF4DETAIL' ):SetDescription( STR0057 ) // 'Histórico Niv.Anterior'
...
oView:EnableTitleView('VIEW_WF1' , STR0052 ) // 'Decisão'
oView:EnableTitleView('VIEW_WF2' , STR0053 ) // 'Informações do Documento'
oView:EnableTitleView('VIEW_WF3' , STR0054 ) // 'Itens'
oView:EnableTitleView('VIEW_WF4' , STR0057 ) // 'Histórico Niv.Anterior'
