...
oModel := MPFormModel():New('WFCN300', /*bPreValidacao*/, /*bPosValidacao*/, {|oModel|A300LibDoc(oModel)}/*bCommit*/, /*bCancel*/ )
...
Static Function WF300Model(aCampos,cStru,oStru)
Local nCampo := 1
Local cCampo := ''
...
Static Function WF300View(aCampos,cStru,oStru)
...
/*/
//-------------------------------------------------------------------
Static Function A300LibDoc(oModel)
...
User Function WF300Descr(cCampo,cChave)
Local aArea	:= GetArea()
Local cDescr	:= ""
