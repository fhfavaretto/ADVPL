...
Definições dos parâmetros que serão permitidos a modificação pela
rotina.Esta função foi necessária devido à migração do dicionário
em banco.
@author  marcio.katsumata
@since   13/11/2019
@version 1.0
@param   aParDef, array, definição do aCols a ser apresentado em tela.
@return  nil,nil
/*/
//-------------------------------------------------------------------
